...
They present the results in [Table 2 of their paper](https://advances.sciencemag.org/content/4/1/eaao5580#T2). Check it out -- what do you conclude?  Would *you* trust a model that works this way for use in the criminal justice system, to help determine peoples' futures?
