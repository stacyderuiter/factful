...
Let's view a bar graph showing proportions male and female olympians (variable `Sex`) by `Year`.
...
- Why is there so much more variation that there was in the other plot by country?
